...
# ─────────────────────────────────────────────────────────────────
# 🔑 EMAIL SETTINGS (Resend API - HTTPS based to bypass Render SMTP block)
# ─────────────────────────────────────────────────────────────────
...
TWILIO_ACCOUNT_SID  = os.environ.get('TWILIO_ACCOUNT_SID', '')  # ← SET THIS
TWILIO_AUTH_TOKEN   = os.environ.get('TWILIO_AUTH_TOKEN', '')       # ← SET THIS
TWILIO_PHONE_NUMBER = os.environ.get('TWILIO_PHONE_NUMBER', '')                      # ← SET THIS

# ─────────────────────────────────────────────────────────────────
# 🔑 GOOGLE OAUTH SETTINGS (for Google Sign-In)
# ─────────────────────────────────────────────────────────────────
# HOW TO GET: Google Cloud Console → APIs & Services → Credentials → OAuth Client ID
GOOGLE_OAUTH_CLIENT_ID = os.environ.get('GOOGLE_OAUTH_CLIENT_ID', '') # ← SET THIS
...
OPENWEATHER_API_KEY = os.environ.get('OPENWEATHER_API_KEY', '')   # ← SET THIS
